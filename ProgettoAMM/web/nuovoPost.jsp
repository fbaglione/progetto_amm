...
<form action="NuovoPost" method="post">
    <div>
        ...
        <textarea name="testoPost" value="${post.getText()}"></textarea>
    </div>
    <div>
        <label for="allegatoPost">Allegato (opzionale)</label>
        <input type="text" name="allegatoPost" value="${post.getContent()}"/>
    </div>
    <div>
    ...
    <input type="hidden" name="mittente" value="${loggedUser.getId()}" />
